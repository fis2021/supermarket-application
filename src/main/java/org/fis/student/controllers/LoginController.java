...
import org.fis.student.exceptions.AccountExists;
...
public class LoginController {
    ...
    public void handleLoginButtonAction() {
        ...
        try{
            org.fis.student.services.UserService.checkUsernameAndPassword(username,password);
        }
        catch(AccountExists e)
        {
            rol = org.fis.student.services.UserService.getUserRole(username, password);
